...
class federated_matrix_factorization_with_projection_p:
    ...
    def train(self, B_1, theta, m_pbm, maxitr = 20, sample_pct = 0.1):
        ...
        for i in range(maxitr):
            ...
            B_sum = cu.zeros((self.__flattern_dim, self.__latent_factor))
            ...
            for j in range(sample_size):
                ...
                B_sum  = B_sum + flat_gradient_B_j 
                
            gradient_B = B_sum / sample_pct # rescale
...
mf.train(B_1 = 0.001, theta = 0.25, m_pbm = 1, maxitr = 200, sample_pct = 0.1)