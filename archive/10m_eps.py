...
k = 14
# privacy budgets
print("eps = 0.5_____________________________________________________________")
pb_eps = 0.5
pb_alpha = 2
p = item_size//2
...
# privacy budgets
print("eps = 0.05_____________________________________________________________")
pb_eps = 0.05
pb_alpha = 2
p = item_size//2
pbm_m, theta = get_theta_m(pb_eps, pb_alpha, 1, user_size, p, k)
...
# privacy budgets
print("eps = 0.01_____________________________________________________________")
pb_eps = 0.01
pb_alpha = 2
p = item_size//2
pbm_m, theta = get_theta_m(pb_eps, pb_alpha, 1, user_size, p, k)
